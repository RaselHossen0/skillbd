    ...
    projects: [
      {
        ...
        description: "Designed a modern and responsive UI for an e-commerce platform selling handcrafted items.",
      ...
      },
      {
        ...
        description: "Built a full-stack task management application with authentication, task tracking, and reporting features.",
      ...
      },
      {
        ...
        description: "Developed a booking system for a local restaurant with table management and reservation features.",
    ...
    certifications: [
      {
        ...
        issuedBy: "SkillBridge Bangladesh",
        date: "November 2023",
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          <h2 className="text-2xl font-bold tracking-tight">Digital Portfolio</h2>
        ...
        <div className="flex items-center gap-2">
          {isEditing ? (
            ...
            <>
              <Button variant="outline" onClick={() => setIsEditing(true)}>Edit Portfolio</Button>
        ...
        <TabsContent value="view" className="space-y-6">
                ...
                <div className="text-center md:text-left">
                  ...
                  {profile.settings.showContact && (
                    <div className="flex flex-wrap gap-3 mt-4">
                      <a href={`mailto:${profile.contact.email}`} className="text-sm text-blue-500 hover:underline">
                        {profile.contact.email}
                      </a>
                      <a href={`https://${profile.contact.linkedIn}`} target="_blank" rel="noopener noreferrer" className="text-sm text-blue-500 hover:underline">
                        LinkedIn
                      </a>
                      <a href={`https://${profile.contact.github}`} target="_blank" rel="noopener noreferrer" className="text-sm text-blue-500 hover:underline">
                        GitHub
                      </a>
                    </div>
                  )}
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>My technical expertise and competencies</CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  <div key={skill.name} className="flex justify-between items-center p-3 border rounded-lg">
                    ...
                    <div className="flex items-center">
                      {Array(5).fill(null).map((_, i) => (
                        <svg
                          key={i}
                          className={`h-4 w-4 ${i < skill.level ? "fill-primary" : "fill-muted"}`}
          ...
          {profile.settings.showProjects && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>My completed projects and work samples</CardDescription>
              </CardHeader>
              <CardContent>
                    ...
                    .map((project) => (
                      <Card key={project.id}>
                        ...
                        <CardHeader className="pb-2">
                          ...
                          <CardDescription>{project.company} • {project.completionDate}</CardDescription>
                        </CardHeader>
          ...
          {profile.settings.showCertifications && profile.certifications.length > 0 && (
            <Card>
              <CardHeader>
                <CardTitle>Certifications</CardTitle>
                <CardDescription>My professional certifications and achievements</CardDescription>
              </CardHeader>
              <CardContent>
                    ...
                    <div key={index} className="p-4 border rounded-lg">
                      <div className="flex flex-col md:flex-row md:justify-between md:items-center">
                        ...
                        <div className="mt-2 md:mt-0">
                          <Badge variant="outline">Credential ID: {cert.credentialId}</Badge>
                        </div>
                      </div>
                    </div>
                  ))}
          ...
          {profile.settings.showMentorship && profile.mentorship.length > 0 && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>My learning journey with industry professionals</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  {profile.mentorship.map((mentorship, index) => (
                    <div key={index} className="p-4 border rounded-lg">
                      <h4 className="font-medium">Mentored by {mentorship.mentor}</h4>
                      <p className="text-sm text-muted-foreground">
            ...
            <CardContent className="space-y-6">
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Switch id="public-profile" checked={profile.settings.isPublic} />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch id="show-contact" checked={profile.settings.showContact} />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch id="show-projects" checked={profile.settings.showProjects} />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch id="show-certifications" checked={profile.settings.showCertifications} />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch id="show-mentorship" checked={profile.settings.showMentorship} />
                </div>
              </div>
