...
export default function CoursesPage() {
  ...
  const allCourses = [
    {
      ...
      description:
        "Master the fundamentals of React.js including components, props, state, hooks, and build your first React application.",
    ...
    },
    {
      ...
      description:
        "Dive deep into Node.js, learn advanced concepts like streams, buffers, clusters, and build scalable backend applications.",
    ...
    },
    {
      ...
      description:
        "Learn the core principles of UI/UX design, wireframing, prototyping, and user research to create intuitive user experiences.",
    ...
    },
    {
      ...
      description:
        "Become a full-stack developer with this comprehensive course covering frontend, backend, databases, and deployment.",
    ...
    },
    {
      ...
      description:
        "Master data analysis, visualization, machine learning and more with Python, pandas, and scikit-learn.",
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-7xl">
                ...
                >
                  ...
                  <CardFooter className="border-t pt-6 pb-6 px-6">
                    {enrolledCourses.some(
                      ...
                      <Button className="w-full py-5 font-medium" disabled>
                        Enrolled
                      </Button>
                    ) : (
                      <Button
            ...
            {enrolledCourses.map((course) => (
              ...
              >
                ...
                <CardFooter className="grid grid-cols-2 gap-4 border-t pt-6 pb-6 px-6">
                  ...
                  <Button className="py-5 font-medium">
                    Continue Learning
                  </Button>
                </CardFooter>
              </Card>
      ...
      {/* Success Dialog */}
      <Dialog open={showEnrollSuccess} onOpenChange={setShowEnrollSuccess}>
